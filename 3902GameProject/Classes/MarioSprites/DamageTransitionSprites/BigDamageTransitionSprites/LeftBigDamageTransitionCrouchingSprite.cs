...
{
    class LeftBigDamageTransitionCrouchingSprite : GenericTallMarioSprite
    {
        private int timer = 0;
        public LeftBigDamageTransitionCrouchingSprite(Texture2D spritesheet) : base(spritesheet)
        {
