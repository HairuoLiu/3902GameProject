...
{
    public class JuggleInstructionScreen : IGameState
    {
        
        public JuggleInstructionScreen()
        {
        ...
        public void Update()
        {
            ...
            {
                Game1.GameInstance.Type = Game1.GameType.MarthJuggle;
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Begin();
            Texture2D texture = BackgroundFactory.Instance.CreateJuggleInstructionTexture();
