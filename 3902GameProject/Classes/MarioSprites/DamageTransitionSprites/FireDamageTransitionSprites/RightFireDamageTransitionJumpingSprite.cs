...
{
    class RightFireDamageTransitionJumpingSprite : GenericTallMarioSprite
    {
        private int timer = 0;
        public RightFireDamageTransitionJumpingSprite(Texture2D spritesheet) : base(spritesheet)
        {
            ...
            SpriteByFrame.Add(1, new Rectangle(UtilityClasses.SpriteUtilityConsts.SJRMXPos1, UtilityClasses.SpriteUtilityConsts.SYPos1, UtilityClasses.SpriteUtilityConsts.SmallSprite, UtilityClasses.SpriteUtilityConsts.SmallSprite));
